    ...
    <footer class="footer-footer section-container">
        <div class="footer-max-width max-content-container">
            <div class="footer-container">
                <img alt="image"
                    src="/playground_assets/copia_de_captura_de_pantalla_2022-11-06_a_la_s__16.58.26_2-removebg-preview-200h.png"
                    class="footer-image" />
                ...
                <div class="footer-social-media">
                    <span class="footer-text1">Follow us</span>
