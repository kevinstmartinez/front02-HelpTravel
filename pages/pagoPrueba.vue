                            ...
                            <div class="card-form">
                                                        ...
                                                        <span v-for="(n, $index) in amexCardMask" :key="$index">
                                                            <transition name="slide-fade-up">
                                                                <div class="card-item__numberItem"
                                                                    v-if="$index > 4 &&
                                                                        $index < 14 && cardNumber.length > $index && n.trim() !== ''">
                                                                    *
                                                                </div>
                                                                <div class="card-item__numberItem"
                                                            ...
                                                            <div class="card-item__name" v-if="cardName.length" key="1">
                                                                <transition-group name="slide-fade-right">
                                                                    <span class="card-item__nameItem"
                                                                        ...
                                                                        v-if="$index === $index" v-bind:key="$index + 1">{{
                                                                            n }}</span>
                                                                </transition-group>
                                                            </div>
                                                            <div class="card-item__name" v-else key="2">Nombre Completo
                                                            </div>
                                                        </transition>
                                                    </label>
                                ...
                                <div>
                                    <div class="card-form__inner">
                                        ...
                                        <div class="card-form__row">
                                            <div class="card-form__col">
                                                <div class="card-form__group">
                                                    <label for="cardMonth" class="card-input__label">Fecha de
                                                        expiración</label>
                                        ...
                                        <div class="card-input-elemt">
                                            <label for="cardNumberE" class="card-input__label">Número de Tarjeta</label>
                                            <div id="cardNumberE" class="card-input__input"></div>
                                        </div>
                                        <button @click="payment" class="card-form__button">Agregar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    async mounted() {
        ...
        this.cardNumberElement.mount('#cardNumberE')
